...
// this mutation will return the url of the file from convex storage
...
// this query will get all the podcasts based on the Author of the podcast , which we are showing in the "Other Podcasts by author" section.
export const getOtherPodcastsByAuthor = query({
  args: {
    podcastId: v.id("podcasts"),
  },
  handler: async (ctx, args) => {
